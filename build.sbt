...
libraryDependencies ++= Seq(
  ...
  "ml.wolfe" %% "wolfe-core" % "0.4.0" exclude("org.slf4j", "slf4j-simple"),
  "ml.wolfe" %% "wolfe-util" % "0.4.0" exclude("org.slf4j", "slf4j-simple"),
  "ml.wolfe" %% "wolfe-examples" % "0.4.0" exclude("org.slf4j", "slf4j-simple"),
  "ml.wolfe" %% "wolfe-nlp" % "0.4.0" exclude("org.slf4j", "slf4j-simple"),
  "ml.wolfe" %% "wolfe-ui" % "0.4.0" exclude("org.slf4j", "slf4j-simple"),
  "org.scala-lang" % "scala-library" % "2.10.3",
  "org.pegdown" % "pegdown" % "1.4.2",
  "ws.securesocial" %% "securesocial" % "2.1.4" exclude("org.slf4j", "slf4j-simple"),
